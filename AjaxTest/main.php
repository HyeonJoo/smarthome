    ...
    <div class="navbar-header">
      ...
      <div class="collapse navbar-collapse navbar-right" >
        <ul class="nav navbar-nav">
          ...
          <li class="intro"><a href="view.php">집상태</a></li>
          <li class="active intro"><a href="control.php">원격 제어</a></li>
        ...
        <div class="col-md-4">
          <div class="thumbnail">
              <div class="caption">
                ...
                <div class="switch" data-name="toggles" data-checked="false" data-value="true">
                    <div class="helper" id="8"></div>
                </div>
              </div>
          </div>
        </div>  
      </div><!--end row -->
    </div><!--end first class div -->
  </div><!--end container white class div-->
</div><!--end connect house class div-->
